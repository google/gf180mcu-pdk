...
**gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 symbol**

.. image:: sc9_sym/CLKINV_X8_sym.png
    :height: 200px
    :width: 400 px
    :align: center
    :alt: gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 symbol

**gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 schematic**

.. image:: sc9_sch/CLKINV_X8_sch.png
    :height: 250px
    :width: 450 px
    :align: center
    :alt: gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 schematic

**gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 layout**

.. image:: sc9_lay/CLKINV_X8_lay.png
    :height: 300px
    :width: 500 px
    :align: center
    :alt: gf180mcu_fd_sc_mcu9t5v0__clkinv_x8 layout
